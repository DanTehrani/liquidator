const HyperEvmMultiFeedAdapterWithoutRoundsV4Abi = [
  {
    inputs: [
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256[]', name: 'values', type: 'uint256[]' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [
      { internalType: 'bytes32[]', name: 'dataFeedsIds', type: 'bytes32[]' },
    ],
...
export default HyperEvmMultiFeedAdapterWithoutRoundsV4Abi;
